...
*Note that while this isn't the latest version, it's needed for the first install, you will need to update the launcher as seen in step 12 before continuing.*
